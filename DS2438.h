 ...
 *   DS2438.h
 *
 *   Originally by Joe Bechter (portions © bechter.com) - https://github.com/jbechter/arduino-onewire-DS2438
 *
 *   Modified by Morten Skriver (Spark Core Compatibility)
 *
 ...
 *       3. Credit is given to the author, and provide a link to the original source.
 *
 */
